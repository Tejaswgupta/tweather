...
import 'package:tweather/views/home_page/page.dart';
...
Future<Widget> createApp() async {
  Function visitor = (String path, Page<Object, dynamic> page) {
  ...
  void Function(String, Page<Object, dynamic>) visitors;
  visitors = visitor;
